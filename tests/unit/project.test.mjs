...
test('cleanBoard applies game-compatible object fields', () => {
  const board = normalizeBoard({
    ...
    objects: [
      ...
      { type: 'donut', x: 220, y: 180, size: 5, angle: -181, donutRadius: 500 },
  ...
  assert.deepEqual(cleanBoard(board).objects.map((object) => ({
    ...
    { type: 'line_aoe', size: 100, angle: -45, arcAngle: undefined, width: 16, height: 384, donutRadius: undefined, transparency: 100 },
    { type: 'donut', size: 10, angle: 179, arcAngle: 360, width: undefined, height: undefined, donutRadius: 240, transparency: 0 },
